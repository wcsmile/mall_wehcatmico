...
　　　　 carrierType: {
    ...
    queryProductList(){
        ...
        APIUtility.get({
            ...
            params: {  product_type: 2, shop_tag: "" },  //话费充值
            succ: (res) => {
                let list = res.list || [];
                list.map((item) => {
            ...
            APIUtility.get({
                ...
                succ: (res) => {
                    ...
                    wx.requestPayment({
                        ...
                        success: (res) => {
                            RedirectUtility.navigateTo("/pages/recharge/rechargesuccess/rechargesuccess?tips=" + "话费充值申请提交成功！" + "&content=" + "提交充值成功，系统将在20分钟内充值到您的手机号，请注意查看。");
                        },
                        fail: (errData) => {
